...
class SSIMFileReader:
    ...
    def __init__(self, ssim_file):
        # ssim_file is a file-like object, not a path
        self.ssim_file = ssim_file

    def get_attributes(self):
        '''
        This function takes an SSIM file-like object and returns a dictionary with the main attributes of the file.
